...
router.route('/visitor/saved').post(SellerAuth, Ecomcontroller.visitor_save_product);
router.route('/visitor/interested').post(SellerAuth, Ecomcontroller.visitor_interested_product);
